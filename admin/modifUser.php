...
$niveau=$_POST['niveau'];
include('../connexion.php');
$req=$bdd->prepare('update user set login=?,password=?,niveau=? where id='.$m);
$req->execute(array($login,$password,$niveau));
          ...
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <form class="user" action="modifUser.php" method="post">
                ...
                <div class="form-group row">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" name="niveau" value="<?php echo $donnee['niveau']?>">
                  </div>
                </div>
